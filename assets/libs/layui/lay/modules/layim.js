...
;layui.define(["layer", "laytpl", "upload", 'element'], function(i) {
    var a = "3.8.0"
        , e = layui.$
        , t = layui.layer
        , n = layui.laytpl
    ...
    var x, b, w, k, C, S = function(i, a, n) {
        ...
        x && x.hide(),
            ...
            t.open({
                ...
                offset: "rb",
                resize: !1,
                content: '<img src="' + (j.mine.avatar || layui.cache.dir + "css/pc/layim/skin/logo.jpg") + '"><span>' + (i || j.base.title || "我的通讯录") + "</span>",
        ...
        msgbox: function() {
            ...
            return t.close(ti.msgbox.index),
                ...
                ti.msgbox.index = t.open({
                    ...
                    success:function(){
                        e('#msgBox').load(j.base.msgbox, function () {
                            e('#msgBox .close').click(function () {
                                layer.close(ti.msgbox.index);
                            });
                        });
                    }
                })
        ...
        about: function() {
            t.alert("版本： " + a + '<br>版权所有：<a href="#" target="_blank">北自所</a>', {
                title: "关于 北自所",
                shade: !1
            })
        },

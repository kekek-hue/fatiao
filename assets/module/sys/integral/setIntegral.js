function Lay(layui) {
    layui.use(['layer', 'ppp', 'form', 'formSelects'], function () {
        ...
        var temp_data = ppp.getTempData('t_integral');
        var role_id;
        var commune_id;
        var role_list = [];
        var commune_list = [];
        ...
        form.on('submit(tag-form-submit)', function (data) {
            var integralData = data.field;
            if (data.field.id) {
                $.post('integral/update/',integralData,function (e) {
                    //弹框显示提示信息
                    layer.msg(e.msg);
                    //关闭所有弹框
                ...
                $.post('integral/add/',integralData,function (e) {
                    //弹框显示提示信息
                    layer.msg(e.msg);
                    //关闭所有弹框
                    layer.closeAll('loading');

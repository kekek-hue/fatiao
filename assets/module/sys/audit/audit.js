    ...
    layui.use(['ppp', 'layedit', 'laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'jquery', 'form', 'config'], function () {
                ...
                table.render({
                    ...
                    parseData: function (res) { //res 即为原始返回的数据
                        ...
                        list.forEach(function (index, item) {
                            index.role = role;
                            index.userId = userid;
                            index.statusAll=setter.statusArticle;
                            index.roleall=setter.roleArticle;
                            index.statusData = status[index.status]
                        })
        ...
        function deleteArticle(data) {
            ...
            for (j = 0; j < len; j++) {
                ...
                jq.post("../../audit/delete", ids, function (data) {
                    if (data.code == 200) {
                        layer.alert('删除成功！', {
                            icon: 1,
                            title: '提示'

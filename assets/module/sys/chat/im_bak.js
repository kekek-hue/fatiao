...
layui.define(["index", "layim"], function (e) {
    ...
    }), t.on("members", function (e) {}), t.on("chatChange", function (e) {
        var a = e.data.type;
    ...
    var a = layui.jquery,
        i = {
            chat: function () {
                ...
                t.setFriendStatus(168168, "offline"), layer.msg("已成功将好友[马小云]置灰", {
                    icon: 1
                })
            }, unGray: function () {
                t.setFriendStatus(168168, "online"), layer.msg("成功取消好友[马小云]置灰状态", {
                    icon: 1
                })
            }, kefu1: function () {
                t.chat({

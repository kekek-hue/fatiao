layui.define('table',function (exports) {
    ...
    Class.prototype.createHTMLDocument = function () {
        ...
        var html = '<div class="layui-card">\
                    <div class="layui-row">\
                      <div class="'+MD5+'">\
                        <table class="layui-hide" id="'+LEFT_TABLE+index+'" lay-filter="'+FILTER+'"><caption>源数据类型</caption></table>\
                      </div>\
    ...
    Class.prototype.render = function () {
        ...
        transfer.callbackFun = options.callbackFun
        transfer.data = [];
    ...
    function datas (type) {
        ...
        transfer.callbackFun(moveData,type);

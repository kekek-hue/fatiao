...
(function () {
    ...
    var ka = da, la = this || self, ma = /^[\w+/_-]+[=]{0,2}$/, oa = null;
    var pa = function () {
    }, qa = function (a) {
 ...
 jQuery v1.9.1 (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    var Ma = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/, Na = function (a) {
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
    var D = window, F = document, Zb = navigator, $b = F.currentScript && F.currentScript.src, ac = function (a, b) {
        var c = D[a];
        D[a] = void 0 === c ? b : c;
        return D[a]
    }, bc = function (a, b) {
        ...
        var e;
        if (null === oa) b:{
            var g = la.document, h = g.querySelector && g.querySelector("script[nonce]");
            if (h) {
    ...
    var Sc = Rc, Tc = null, Uc = null, Vc = null, Wc = "//www.googletagmanager.com/a?id=" + Nc.m + "&cv=1", Xc = {},
        Yc = {}, Zc = function () {
            var a = Oc.sequence || 0;
            Oc.sequence = a + 1;
            return a
        };
    var $c = {}, I = function (a, b) {
        $c[a] = $c[a] || [];
        $c[a][b] = !0
    }, ad = function (a) {
    ...
    var cd = function () {
        ...
        var a = gd;
        if (void 0 === a) return "";
        var b = ad("GTM"), c = ad("TAGGING");
        return [pd, hd[a] ? "" : "&es=1", qd[a], b ? "&u=" + b : "", c ? "&ut=" + c : "", cd(), id, jd, od, "&z=0"].join("")
    }, rd = function () {
        return [Wc, "&v=3&t=t", "&pid=" +
        wa(), "&rv=" + Nc.Db].join("")
    }, sd = "0.005000" > Math.random(), pd = rd(), td = function () {
        pd = rd()
    }, hd = {}, id = "", jd = "", od = "", gd = void 0, qd = {}, kd = {}, dd = void 0, ld = function (a, b) {
        var c = 0, d = 0;
        return {
            Fg: function () {
                if (c < a) return !1;
    ...
    var Od = function (a, b, c) {
            ...
            var d = Nd();
            D[a.functionName] = d;
            if (a.Gb) for (var e = 0; e < a.Gb.length; e++) D[a.Gb[e]] = D[a.Gb[e]] || Nd();
        ...
        Rd = {Ce: "", pf: "1"}, Sd = {
            ...
            Gb: [Qd.functionName, Pd.functionName],
            $c: "www.gstatic.com/call-tracking/call-tracking_" + (Rd.Ce || Rd.pf) + ".js"
        }, Td = {}, Ud = function (a, b, c, d) {
            I("GTM", 22);
            if (c) {
                d = d || {};
                var e = Od(Pd, d, a), g = {ak: a, cl: b};
            ...
            if (b && c) {
                ...
                for (var e = {
                    ...
                    Td[h.id] || (h && "AW" === h.prefix && !e.adData && 2 <= h.h.length ? (e.adData = {
                        ak: h.h[0],
                        cl: h.h[1]
                    }, Td[h.id] = !0) : h && "UA" === h.prefix && !e.gaData && (e.gaData = {gaWpid: h.containerId}, Td[h.id] = !0))
                }
            ...
            if (a) if (Ld()) {
                ...
                var d = function (x) {
                    return b ? b.getWithConfig(x) : Ed(x, a.containerId, a.id)
                }, e = void 0, g = !1, h = d(H.Ze);
                if (h && ua(h)) {
                    e = [];
                ...
                if (!e || g) {
                    ...
                    if (m) {
                        n = ua(m) ? m : [m];
                        var q = d(H.Cd), u = d(H.Dd), p = d(H.Fd), r = d(H.Ye),
                            v = q || u, w = 1;
                        "UA" !== a.prefix || e || (w = 5);
                        for (var y = 0; y < n.length; y++) y < w && (e ? Wd(e, n[y], r, {
                            ba: v,
                            options: p
                        }) : "AW" === a.prefix && a.h[1] ? Xd() ? Wd([a], n[y], r || "US", {
                            ba: v,
                            options: p
                        }) : Ud(a.h[0], a.h[1], n[y], {
                            ba: v,
                            options: p
                        }) : "UA" === a.prefix && (Xd() ? Wd([a], n[y], r || "US", {ba: v}) : Vd(a.containerId, n[y], {ba: v})))
                    }
                }
            }
        };
    var ae = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/), be = {
        cl: ["ecl"],
    ...
    var fe = function (a) {
        ...
        return function (h) {
            ...
            if (b) {
                var n;
                if (n = m) a:{
                    if (0 > t(c, k)) if (l && 0 < l.length) for (var q = 0; q < l.length; q++) {
                        if (0 > t(c, l[q])) {
                            I("GTM", 11);
                            n = !1;
                            break a
    ...
    function ne(a) {
        if (!ke) {
            ...
            if (!a || "readystatechange" != a.type || c || !b && d) {
                ke = !0;
                for (var e = 0; e < me.length; e++) G(me[e])
            }
            me.push = function () {
    ...
    function we(a) {
        ...
        if (!Oc._li && D.performance && D.performance.timing) {
            var b = D.performance.timing.navigationStart, c = ra(Dd.get("gtm.start")) ? Dd.get("gtm.start") : 0;
...
*/
    ...
    function We(a, b, c, d) {
        function e() {
            if (g[Gb.jf]) k(); else {
                var w = Cb(g, c, []), y = se(c.id, String(g[Gb.ma]), Number(g[Gb.Ld]), w[Gb.kf]), x = !1;
        ...
        var g = sb[a], h = b.s, k = b.o, l = b.terminate;
        if (c.Jc(g)) return null;
        var m = Bb(g[Gb.Md], c, []);
        if (m && m.length) {
            var n = m[0], q = Ve(n.index, {s: h, o: k, terminate: l}, c, d);
            if (!q) return null;
            h = q;
            k = 2 === n.Wd ? l : q
        }
        if (g[Gb.Jd] || g[Gb.lf]) {
            var u = g[Gb.Jd] ? ub : c.ih, p = h, r = k;
            if (!u[a]) {
                e = Ha(e);
                var v = Xe(a, u, e);
                h = v.s;
    ...
    function $e(a, b) {
        ...
        for (var c = [], d = 0; d < sb.length; d++) if (a.kb[d]) {
            var e = sb[d];
            var g = b.add();
            try {
    ...
    function af(a, b) {
        if (!sd) return;
        var c = function (d) {
            var e = b.Jc(sb[d]) ? "3" : "4", g = Bb(sb[d][Gb.Kd], b, []);
    ...
    var df = !1, ef = function (a, b, c, d, e) {
        if ("gtm.js" == b) {
            if (df) return !1;
            df = !0
        }
        ...
        Jd(a, "gtm");
        var h = {
            id: a, name: b, Jc: fe(c), kb: [], ih: [], he: function () {
                I("GTM", 6)
            }
        };
        h.kb = Kb(h);
        ...
        for (var l = 0; l < h.kb.length; l++) if (h.kb[l]) {
            var m = sb[l];
            if (m && !Qc[String(m[Gb.ma])]) return !0
        }
        return !1
    };
    var ff = function (a, b) {
    ...
    mf.prototype.getWithConfig = function (a) {
        ...
        if (void 0 !== this.Ma[a]) return this.Ma[a];
    ...
    var Af = function (a, b, c) {
        ...
        if (d.L) {
            var e =
                Gf(a, d.L), g = e.pe;
            if (g) {
                var h = C(c), k = C(e.targetConfig[d.L]), l = C(e.containerConfig), m = C(e.Ma), n = C(a.$d),
                    q = Cd("gtm.uniqueEventId"), u = Kc(d.L).prefix,
    ...
    zf.prototype.register = function (a, b, c) {
        if (3 !== Gf(this, a).status) {
            ...
            Gf(this, a).status = 3;
            c && (Gf(this, a).Ma = c);
            var d = Kc(a), e = Df[d.containerId];
            if (void 0 !== e) {
                var g = Oc[d.containerId].bootstrap, h = d.prefix.toUpperCase();
                Oc[d.containerId]._spx && (h = h.toLowerCase());
                var k = Cd("gtm.uniqueEventId"), l = h, m = Fa() - g;
                if (sd && !kd[k]) {
                    k !== gd && (ed(), gd = k);
    ...
    zf.prototype.push = function (a, b, c, d) {
        ...
        if (c) {
            ...
            if (h && (Gf(this, c).status = 2, this.push("require", [], g.containerId), Df[g.containerId] = Fa(), !Ld())) {
                var m = encodeURIComponent(g.containerId), n = ("http:" != D.location.protocol ? "https:" : "http:") +
    ...
    zf.prototype.flush = function (a) {
        for (var b = this; this.eb.length;) {
            var c = this.eb[0];
            if (c.defer) c.defer = !1, this.eb.push(c); else switch (c.type) {
                case "require":
                ...
                case "set":
                    ...
                    break;
                case "config":
                    var d = c.Hb[0], e = !!d[H.yb];
                    delete d[H.yb];
                    var g = Gf(this, c.L), h = Kc(c.L), k = h.containerId === h.id;
    ...
    var Qf = function (a, b, c, d, e, g) {
        ...
        a:{
            ...
            if ("auto" === q) {
                ...
                k = !1
            } else q && "none" != q && (m += "; domain=" + q), k = !Pf(q, u) && Mf(m, a, l)
        }
        return k
    };
    ...
    var Rf = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/, Sf = /(^|\.)doubleclick\.net$/i, Pf = function (a, b) {
    ...
    var eg = {
        ...
        event: function (a) {
            ...
            if (f(b) && !(3 < a.length)) {
                ...
                var d = Zf(b, c);
                var e;
                var g = c, h = Cd("gtag.fields.send_to", 2);
                f(h) || (h = H.Aa);
                var k = g && g[h];
    ...
    function sg() {
        if (!qg) {
            qg = !0;
            for (var a = 0; a < rg.length; a++) G(rg[a])
        }
    }
    ...
    var ug = [], vg = !1, wg = function (a) {
        return D["dataLayer"].push(a)
    }, xg = function (a) {
        var b = Oc["dataLayer"], c = b ? b.subscribers : 1, d = 0;
        return function () {
            ++d === c && a()
        }
    };
    ...
    function zg(a) {
        var b = a.event, c = a["gtm.uniqueEventId"], d, e = Oc.zones;
            ...
            if (null != b) {
                ...
                try {
                    if (qa(b)) try {
                        ...
                        if (f(l[0])) {
                            var m =
                                l[0].split("."), n = m.pop(), q = l.slice(1), u = Cd(m.join("."), 2);
    ...
    var Dg = function () {
        ...
        a.push = function () {
            ...
            if (0 < Oc.SANDBOXED_JS_SEMAPHORE) {
                d = [];
                for (var e = 0; e < arguments.length; e++) d[e] = new pg(arguments[e])
    ...
    var Fg = function (a) {
        this.resolve = function (b) {
            for (var c = [], d = 0; d < a.length; d++) c.push(a[d] === Eg.zb ? b : a[d]);
            return c.join("")
        }
    };
    ...
    var Rg = ["1"], Sg = {}, Wg = function (a, b, c, d) {
        var e = Tg(a);
    ...
    var ih = function () {
        var a = fh, b = gh, c = hh(), d = function (h) {
    ...
    var jh = /(.*?)\*(.*?)\*(.*)/, kh = /^https?:\/\/([^\/]*?)\.?cdn\.ampproject\.org\/?(.*)/,
        lh = /^(?:www\.|m\.|amp\.)+/, mh = /([^?#]+)(\?[^#]*)?(#.*)?/, nh = /(.*?)(^|&)_gl=([^&]*)&?(.*)/,
        ph = function (a) {
            var b = [], c;
            for (c in a) if (a.hasOwnProperty(c)) {
                var d = a[c];
            ...
            return function (a) {
                var b = Qe(D.location.href), c = b.search.replace("?", ""), d = Me(c, "_gl", !0) || "";
                a.query = qh(d) || {};
            ...
            try {
                if (a) {
                    ...
                    if (h && "1" === h[1]) {
                        var k = h[3], l;
                        a:{
                            for (var m = h[2], n = 0; n < b; ++n) if (m === oh(k, n)) {
                                l = !0;
                                break a
                            }
                            l = !1
                        ...
                        if (l) {
                            for (var q = {}, u = k ? k.split("*") : [], p = 0; p < u.length; p += 2) q[u[p]] = ch(u[p + 1]);
                            return q
                        }
                    }
                }
    ...
    var fh = function (a) {
        ...
        var a = F.location.hostname, b = kh.exec(F.referrer);
        if (!b) return !1;
        var c = b[2], d = b[1], e = "";
        if (c) {
            var g = c.split("/"), h = g[1];
        ...
        var k = a.replace(lh, ""), l = e.replace(lh, ""), m;
        if (!(m = k === l)) {
            var n = "." + l;
    ...
    var zh = {};
    var Ah = /^\w+$/, Bh = /^[\w-]+$/, Ch = /^~?[\w-]+$/, Dh = {aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp"};
    ...
    var Gh = function () {
        var a = Qe(D.location.href), b = Pe(a, "query", !1, void 0, "gclid"), c = Pe(a, "query", !1, void 0, "gclsrc"),
    ...
    function Hh(a, b, c) {
        ...
        b = b || {};
        var e = Eh(b.prefix), g = b.domain || "auto", h = b.path || "/", k = void 0 == b.Ja ? 7776E3 : b.Ja;
        c = c || Fa();
    ...
    var Lh = function (a, b, c, d, e) {
        for (var g = sh(), h = Eh(b), k = 0; k < a.length; ++k) {
            ...
            if (void 0 !== Dh[l]) {
                var m = Jh(l, h), n = g[m];
                if (n) {
                    var q = Math.min(Kh(n), Fa()), u;
                    b:{
                        for (var p = q, r = If(m, F.cookie), v = 0; v < r.length; ++v) if (Kh(r[v]) > p) {
                            u = !0;
                            break b
                        }
                        u = !1
    ...
    function Rh(a) {
        var b = Qe(D.location.href), c = Pe(b, "host", !1);
        if (c && c.match(Qh)) {
    ...
    var Th = function () {
        ...
        Wg(b, c, d, e);
        var g = Sg[Tg(b)], h = Gh().dc || [], k = !1;
        if (g && 0 < h.length) {
            var l = Oc.joined_au = Oc.joined_au || {}, m = b || "_gcl";
            if (!l[m]) for (var n = 0; n < h.length; n++) {
                var q = "http://ad.doubleclick.net/ddm/regclk", u = q = q + "?gclid=" + h[n] + "&auiddc=" + g;
    ...
    var Vh;
    if (3 === Nc.Db.length) Vh = "g"; else {
        var Wh = "G";
        Wh = "g";
        Vh = Wh
    }
    var Xh = {"": "n", UA: "u", AW: "a", DC: "d", G: "e", GF: "f", HA: "h", GTM: Vh, OPT: "o"}, Yh = function (a) {
        var b = Nc.m.split("-"), c = b[0].toUpperCase(), d = Xh[c] || "i",
    ...
    var Zh = function (a) {
        ...
        if (5 === b.S) c = "1"; else if (6 === b.S) c = b.Xc; else return !1;
        Zh(c) && a("qty", c);
        Zh(b.Jb) && a("cost", b.Jb);
        Zh(b.transactionId) && a("ord", b.transactionId);
        return !0
    }, ai = encodeURIComponent, bi = function (a, b) {
        function c(n, q, u) {
    ...
    var ci = ["input", "select", "textarea"], di = ["button", "hidden", "image", "reset", "submit"], ei = function (a) {
    ...
    var ii = function (a) {
        ...
        var c = b, d = "/pagead/conversion/" + hi(a.conversion_id) + "/?", e = hi(JSON.stringify(a[c])),
            g = "https://www.googletraveladservices.com/travel/flights/clk" + d + c + "=" + e;
        if (a.conversionLinkerEnabled) {
            var h = Sh("gf", a.cookiePrefix);
            if (h && h.length) for (var k = 0; k < h.length; k++) g += "&gclgf=" + hi(h[k])
        }
    ...
    var ji = !!D.MutationObserver, ki = void 0, li = function (a) {
        if (!ki) {
            var b = function () {
                var c = F.body;
                if (c) if (ji) (new MutationObserver(function () {
                    for (var e = 0; e < ki.length; e++) G(ki[e])
    ...
    var Hi = D.clearTimeout, Ii = D.setTimeout, T = function (a, b, c) {
            if (Ld()) {
                b && G(b)
    ...
    function uj(a) {
        ...
        if (a.any_of && ua(c)) {
            for (var d = 0; d < c.length; d++) if (tj({"function": a["function"], arg0: b, arg1: c[d]})) return !0;
            return !1
        }
        switch (a["function"]) {
            case "_cn":
    ...
    var wj = {}, xj = encodeURI, X = encodeURIComponent, yj = fc;
    var zj = function (a, b) {
        if (!a) return !1;
        var c = Pe(Qe(a), "host");
        if (!c) return !1;
    ...
    var Vk = window, Wk = document, Xk = function (a) {
        ...
        for (var d = If("AMP_TOKEN", Wk.cookie, !0), e = 0; e < d.length; e++) if ("$OPT_OUT" == d[e]) return !0;
    ...
    var il = function (a) {
        var b = kf(a, "/2");
        return b ? b : -1 === navigator.userAgent.toLowerCase().indexOf("firefox") ? P("https://", "http://", "www.googleadservices.com/pagead/conversion_async.js") : "https://www.google.com/pagead/conversion_async.js"
    }, jl = !1, kl = [], ll = ["aw", "dc"], ml = function (a) {
        var b = D.google_trackConversion, c = a.gtm_onFailure;
        "function" == typeof b ? b(a) || c() : c()
    }, nl = function () {
        for (; 0 < kl.length;) ml(kl.shift())
    }, ol = function (a) {
        if (!jl) {
            jl = !0;
            ye();
    ...
    var rl = function (a, b, c, d) {
        var e = Kc(a), g = b == H.w, h = e.h[0], k = e.h[1], l = void 0 !== k, m = function (Q) {
                return d.getWithConfig(Q)
            }, n = !1 !== m(H.xa), q = m(H.wa) || m(H.P), u = m(H.T),
            p = m(H.U), r = il(m(H.da));
        if (g) {
            var v = m(H.ka) || {};
            if (n) {
        ...
        if (!g || !l && !x) if (!0 === m(H.rd) && (l = !1), !1 !== m(H.O) || l) {
            var z = {
    ...
    var sl = function (a, b, c, d, e, g) {
        ...
        var d = /^u([1-9]\d?|100)$/, e = a.getWithConfig(H.Le) || {}, g = Hd(b, c);
        var h = {}, k = {};
        if (Pa(e)) for (var l in e) if (e.hasOwnProperty(l) &&
            d.test(l)) {
            var m = e[l];
            f(m) && (h[l] = m)
        }
        ...
        var c = encodeURIComponent, d = [], e = a(H.Y) || [];
        ...
        if (b) {
            ...
            if (c) return {containerId: "DC-" + b[1], L: b[3] ? a : "", uf: b[1], tf: b[3] || "", cb: b[4] || "", S: c}
        }
    }, xl = function (a, b, c, d) {
        var e = vl(a);
        if (e) {
            ...
            }, h = !1 !== g(H.xa), k = g(H.wa) || g(H.P), l = g(H.T), m = g(H.U), n = g(H.Ne), q = 3 === Md();
            if (b === H.w) {
                var u = g(H.ka) || {}, p = g(H.Qa), r = void 0 === p ? !0 : !!p;
                if (h) {
                    if (yh(u[H.Sa], !!u[H.F])) {
                        Lh(wl, k, void 0, l,
                            m);
                ...
                if (u[H.F]) {
                    Nh(wl, u[H.F], u[H.Ua], !!u[H.Ta], k);
                }
                if (n && n.exclusion_parameters && n.engines) if (Ld()) {
                } else sl(n, q, h, k, l, m);
                G(d.s)
            } else {
                var w = {}, y = g(H.Me);
                if (Pa(y)) for (var x in y) if (y.hasOwnProperty(x)) {
                    var z = y[x];
                    void 0 !== z && null !==
                    z && (w[x] = z)
                }
                ...
                var A = tl(d, e.containerId, e.L), E = !0 === g(H.Ge);
                if (Ld() && E) {
                    E = !1
                }
                var J = {
    ...
    var yl = /.*\.google\.com(:\d+)?\/booking\/flights.*/, Al = function (a, b, c, d) {
            ...
            }, g = Kc(a).h[0], h = !1 !== e(H.xa), k = e(H.wa) || e(H.P), l = e(H.T), m = e(H.U);
            if (b === H.w) {
                if (h) {
    ...
    var Dl = function (a, b, c, d) {
        var e = Kc(a), g = !1 !== d.getWithConfig(H.xa), h = d.getWithConfig(H.wa) || d.getWithConfig(H.P),
            k = d.getWithConfig(H.T), l = d.getWithConfig(H.U);
        if (b === H.w) {
            ...
            if (m[H.F]) {
                Nh(Bl, m[H.F], m[H.Ua], !!m[H.Ta], h);
            }
            G(d.s)
        } else if ("purchase" === b) {
            var q = d.getWithConfig(H.Ya), u = d.getWithConfig(H.Z),
                p = d.getWithConfig(H.ca), r = d.getWithConfig(H.Y), v = {};
            ...
            var y = e.h[0], x = d.s, z = d.o;
            /^\d+$/.test(y) ? fc(Cl(y, v, g, h), x, z) : G(z)
        } else G(d.o)
    }, Cl = function (a, b, c, d) {
        var e = encodeURIComponent(a), g = encodeURIComponent(El(b)),
            h = "https://www.googletraveladservices.com/travel/clk/pagead/conversion/" +
                e + "/?data=" + g;
        c && (h += Sh("ha", d).map(function (k) {
    ...
    var Sl = function (a, b, c, d) {
        var e = "https://www.google-analytics.com/analytics.js", g = Fe();
        if (qa(g)) {
            var h = "gtag_" + a.split("-").join("_"), k = function (x) {
                ...
                if (z) {
                    var B = z.action;
                    if ("impressions" === B) x("ec:addImpression", z.yg); else if ("promo_click" === B || "promo_view" === B) {
                        var A = z.Uc;
                        x("ec:addPromo", z.Uc);
            ...
            (function (x) {
                if (x) {
                    var z = {};
                    if (Pa(x)) for (var B in Pl) Pl.hasOwnProperty(B) && Ql(Pl[B], B, x[B], z);
                    k("require", "linkid", z)
                }
            })(n.linkAttribution);
            var u = n[H.ka];
            ...
            if (b === H.cc) m(), k("send", "pageview", n.ia); else if (b === H.w) {
                m();
                var v = !1;
                v ? Yd(a, d) : Yd(a);
                ...
                !0), void 0 !== n.eventLabel && r("eventLabel", n.eventLabel, !0), void 0 !== n.value && r("eventValue", Aa(n.value)), k("send", "event", n.ia));
            if (!Rl) {
                Rl = !0;
                ye();
                var w = d.o, y = function () {
                    De().loaded || w()
                };
                Ld() ? G(y) : cc(e, y, w)
            }
        ...
        content_id: 1, event_category: 1, event_action: 1, event_label: 1, link_attribution: 1, linker: 1,
        method: 1, name: 1, send_page_view: 1, value: 1
    }, Pl = {cookie_name: 1, cookie_expires: "duration", levels: 1}, Wl = {
        anonymize_ip: 1,
        fatal: 1,
        non_interaction: 1,
        use_amp_client_id: 1,
        ...
        if (void 0 !== c) if (Wl[b] && (c = Ca(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[Nl(b)] = c; else if (f(a)) d[a] = c; else for (var e in a) a.hasOwnProperty(e) && void 0 !== c[e] && (d[a[e]] = c[e])
    }, Nl = function (a) {
        ...
        l && Ol(h, "exp", l);
        var m = e("custom_map");
        if (Pa(m)) for (var n in m) if (m.hasOwnProperty(n) && /^(dimension|metric)\d+$/.test(n) && void 0 != m[n]) {
            var q = e(String(m[n]));
            void 0 !== q && Ol(h, n, q)
        }
        var u = Hd(a);
        ...
        }, h = g(H.Y), k, l = 0; h && l < h.length && !(k = h[l][H.fc]); l++) ;
        var m = g("custom_map");
        if (Pa(m)) for (var n = 0; h && n < h.length; ++n) {
            var q = h[n], u;
        ...
        "purchase" === a || "refund" === a ? p = {
            ...
            ab: e(),
            La: d(h)
        } : "add_to_cart" === a ? p = {action: "add", La: d(h)} : "remove_from_cart" === a ? p = {
            action: "remove",
            La: d(h)
        } : "view_item" === a ? p = {
            action: "detail",
            ...
            action: "impressions",
            yg: d(h)
        } : "view_promotion" === a ? p = {action: "promo_view", Uc: d(r)} : "select_content" === a &&
        r && 0 < r.length ? p = {action: "promo_click", Uc: d(r)} : "select_content" === a ? p = {
            action: "click",
            ab: {list: g(H.fc) || k},
            La: d(h)
            ...
            action: "checkout",
            La: d(h),
            ab: {step: "begin_checkout" === a ? 1 : g(H.zd), option: g(H.yd)}
        } : "set_checkout_option" === a && (p = {action: "checkout_option", ab: {step: g(H.zd), option: g(H.yd)}});
        p && (p.Eh = g(H.ca));
        return p
    }, Zl = {}, Ll = function (a, b) {
        var c = Zl[a];
    ...
    Y.a.gtagha = ["google"], function () {
        var a = !1;
        var b = function (c) {
            var d = c.vtp_conversionId, e = Vc, g = V("eventModel");
            if (a) {
                Af(d.id, Dl);
                if (e === H.w) {
                ...
                k.getWithConfig = function (l) {
                    return Ed(l, d.containerId, d.id)
                };
    ...
    Y.a.gtagaw = ["google"], function () {
        ...
        a = !0;
        var b = function (c) {
            var d = c.vtp_conversionId, e = void 0 !== d.h[1] ? d.id : void 0, g = Vc, h = V("eventModel");
            if (a) {
    ...
    Y.a.get = ["google"], function () {
        (function (a) {
            ...
            if (a.vtp_isAutoTag) {
                var b = String(a.vtp_trackingId), c = Vc || "", d = {};
                if (c === H.w) {
                ...
                var h = a.vtp_settings, k = h.eventParameters, l = h.userProperties;
    ...
    Y.a.gtagfl = [], function () {
        ...
        var b = !1;
        var c = function (d) {
            var e = d.vtp_targetId, g = Vc, h = V("eventModel");
            if (b) {
                Af(e, xl);
                if (g === H.w) {
    ...
    Y.a.gtagua = ["google"], function () {
        var a = !1;
        var b = function (c) {
            var d = c.vtp_trackingId, e = Vc, g = V("eventModel");
            if (a) {
                Af(d, Sl);
                if (e === H.w) {
    ...
    var $l = {};
    $l.macro = function (a) {
        if (Eg.wc.hasOwnProperty(a)) return Eg.wc[a]
    ...
    function bm() {
        ...
        if (Oc[Nc.m]) {
            ...
            ke = !1;
            le = 0;
            if ("interactive" == F.readyState && !F.createEventObject || "complete" == F.readyState) ne(); else {
